...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        tbody tr.clickable-row:hover .customer-name { color: #1d4ed8; }
        a { color: #2563eb; text-decoration: none; }
        a:focus { outline: 2px solid #93c5fd; outline-offset: 2px; border-radius: 2px; }
        .customer-name { font-weight: 600; line-height: 1.4; display: block; }
        .customer-username { font-size: .8rem; color: #6b7280; margin-top: 2px; }
        .msg-preview { font-size: .825rem; color: #4b5563; max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; line-height: 1.5; }
                ...
                <tbody>
                    @forelse ($customers as $customer)
                        @php
                            ...
                            $link = "/customers/{$customer->platform}/{$customer->platform_user_id}";
                        @endphp
                        <tr class="clickable-row" onclick="location.href='{{ $link }}'" title="Open conversation">
                            <td>
                                <a href="{{ $link }}" class="customer-name" onclick="event.stopPropagation()">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="empty">
                                ...
                                <p>Send a message to your Telegram bot and it will appear here.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
